    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.container}>
        ...
        <View style={{ padding: 10 }}>
          <Text style={{ fontSize: '20', fontWeight: '600' }}>현재 {name}님이 보유 중인 금액</Text>
          <Text style={{ fontSize: '14', marginTop: '5' }}>지금까지의 현금 지출을 반영했어요</Text>
...
const styles = StyleSheet.create({
  ...
  change: {
    color: '#3374F6', fontSize: 14, fontWeight: '600', marginTop: 6
  },
  bill: {
    padding: 10,
    gap: 3,
